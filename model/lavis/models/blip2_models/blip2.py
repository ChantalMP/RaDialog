...
class Blip2Base(BaseModel):
    ...
    def init_vision_encoder(
        ...
        ln_vision = LayerNorm(visual_encoder.num_features) if model_name != "biovil" else LayerNorm(1408)
        self.vit_name = model_name
        return visual_encoder, ln_vision, visual_encoder.num_features if model_name != "biovil" else 1408
