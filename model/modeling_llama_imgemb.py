...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        with open(f"pretraining/embs/stage1_pt_instruct_blip_origlr_img448_embeddings_train_all.pkl", "rb") as f:
    ...
    def forward(
        ...
        if inputs_embeds is None:
            if dicom is not None:
                image_embs = self.img_proj_layer(torch.tensor(np.array([self.blip_embeddings[d] for d in dicom])).to(self.device))
